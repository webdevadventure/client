...
export const Frame: React.FC<FrameProps> = ({
  ...
  return (
    <Link
      to={`/details/${id}`}
      className="block w-[851px] hover:shadow-xl transition-shadow duration-300"
    >
      <div className="grid grid-cols-[3fr_7fr] bg-[#fafafa] font-Nunito shadow-lg rounded-lg relative my-6">
        {/* Picture */}
